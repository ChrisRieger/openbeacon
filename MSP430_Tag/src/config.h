...
#define CONFIG_PIN_CSN_HIGH P2OUT|=CSN		//POUT --> P2OUT
#define CONFIG_PIN_CSN_LOW P2OUT&=~CSN		//POUT --> P2OUT
#define CONFIG_PIN_CE_HIGH P2OUT|=CE		//POUT --> P2OUT
#define CONFIG_PIN_CE_LOW P2OUT&=~CE		//POUT --> P2OUT
